...
EMAIL_HOST = 'smtp.gmail.com'  # You can use Gmail or any other email service
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'jouidamedrayen@gmail.com'  # Your email address
EMAIL_HOST_PASSWORD = 'dixlydevhzuxcube'  # Use the app password without spaces
